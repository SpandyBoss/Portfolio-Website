                ...
                <div className="mt-6 lg:mt-0 lg:flex-1">
                    <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                        <div>
                            ...
                            <Link href="/" className="block mt-2 text-sm text-gray-600 dark:text-white hover:underline">Home</Link>
                            <br />
                            <Link href="#abt" className="block mt-2 text-sm text-gray-600 dark:text-white hover:underline">About</Link>
                            <br />
                            <Link href="/ama" className="block mt-2 text-sm text-gray-600 dark:text-white hover:underline">AMA</Link>
                        </div>
